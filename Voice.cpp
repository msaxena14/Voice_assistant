...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning Mr.Madhavam"<<endl;
        string phrase = "Good Morning Mr.Madhavam";
        ...
        cout<< "Good Afternoon Mr.Madhavam"<<endl;
        string phrase = "Good Afternoon Mr.Madhavam";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening Mr.Madhavam"<<endl;
        string phrase = "Good Evening Mr.Madhavam";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE Mr.Madhavam|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE Mr.Madhavam";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="OffensiveXX")
        {
            cout<<"\n<**************************************************************************************************>\n\n";
            greetings();
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you Mr.Madhavam...."<<endl<<endl;

                string phrase = "How can i help you Mr.Madhavam";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"Hello Mr.Madhavam....."<<endl;
                    string phrase = "Hello Mr.Madhavam";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"I'm a personal assistant created by Mr.Madhavam !!!"<<endl;
                    string phrase = "I'm a personal assistant created by Mr.Madhavam !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                else if(command=="open notepad")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    CreateProcess(TEXT("C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Accessories\\notepad.exe"), NULL, NULL, NULL, FALSE, NULL, NULL, NULL, &startInfo, &processInfo);
                }
                ...
                else if(command=="open Microsoft Paint")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    CreateProcess(TEXT("C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Accessories\\Paint.ink"), NULL, NULL, NULL, FALSE, NULL, NULL, NULL, &startInfo, &processInfo);
                }
                ...
                else if(command=="play music")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    mciSendString("open \"295-official-audio-sidhu-moose-wala-the-kidd-moosetape.mp3", NULL, 0, NULL);
                ...
                else if(command=="open photo")
                {
                    ...
                    string phrase = "opening photos";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,"open","C:\\Users\\abhi1\\OneDrive\\Pictures",NULL, NULL, SW_NORMAL);
                }
                ...
                else if(command=="open oops book")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,"open","C:\\Users\\abhi1\\OneDrive\\Desktop",NULL, NULL, SW_NORMAL);
                }
                ...
                else if(command=="open video")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,"open","C:\\Users\\abhi1\\Videos",NULL, NULL, SW_NORMAL);
                }

                else if(command=="bye" || command=="exit")
                {
                    cout<<"Good Bye Mr.Madhavam, see you soon!"<<endl;
                    string phrase = "Good Bye Mr.Madhavam, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
